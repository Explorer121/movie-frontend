    ...
    const renderItems = (items, idx) => (
      ...
      >
        ...
        >
          ...
          <Link to={`/action-details/${items.slug}`}><CgDetailsMore style={{ color: '#d61b05' }} /></Link>
     ...
     return (
      <div className='action'>
        ...
        <div>
        <Slider {...settings}>
            {action.map(item => renderItems(item))}
        </Slider>
        </div>
